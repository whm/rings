...
print ">>> ring-delete-info.pl                    v:10-Jul-2006\n";
...
$sel .= "LEFT OUTER JOIN pictures_raw r ";
$sel .= "ON (i.pid = r.pid) ";
$sel .= "WHERE r.pid IS NULL ";
...
my $cmd = "DELETE FROM pictures_information ";
$cmd .= "WHERE pid = ? ";
...
foreach my $i (@pidList) {
    if ($opt_update) {
        ...
        print "Proposing to delete pictures_information for $i\n";
    }
}
...
Delete picture information that has no corresponding picture.
