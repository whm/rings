...
if (isset($in_ring_pid)) {
  ...
  if ($result) {
    ...
    echo "<img src=\"/rings/display.php?in_pid=$this_pid&in_size=larger\">\n";
  ...
  if (strlen($_SESSION['prideindustries_directory_user'])>0) {
    ...
    echo '<a href="'.$PHP_SELF.'?in_logout=1&in_ring_uid='.$in_ring_uid.'">';
    echo 'Logout';
    echo "</a>\n";
  } else {
    echo '<a href="'.$PHP_SELF.'?in_login=2&in_ring_uid='.$in_ring_uid.'">';
    echo 'Login'."</a>\n";
  }
